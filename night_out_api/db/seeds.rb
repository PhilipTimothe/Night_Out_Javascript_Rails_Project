...
restaurants.each do |restaurant|
    Api::V1::Restaurant.create(name: restaurant[:name], cuisine: restaurant[:cuisine], style: restaurant[:style], phone_number: restaurant[:phone_number], menu: restaurant[:menu], address: restaurant[:address], image: restaurant[:image], likes: restaurant[:likes])
end